<?php
	...
	$SelectUser=ejecutarSQL::consultar("SELECT * FROM cliente WHERE RIF='".$code."'");
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12">
                    <div class="form-group label-floating">
                      <label class="control-label"><i class="fa fa-address-card-o" aria-hidden="true"></i>&nbsp; CI</label>
                      <input class="form-control" type="text" required readonly name="clien-rif" value="'.$DataUser['RIF'].'">
                    </div>
                  </div>
